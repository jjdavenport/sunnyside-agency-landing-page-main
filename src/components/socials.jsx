const Socials = () => {
  return (
    <section className="flex flex-col items-center gap-14 bg-moderateCyan p-16">
      <svg width="124" height="24" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="#FFF"
          fillRule="nonzero"
          className="fill-darkCyan"
        />
      </svg>
      <ul className="flex gap-12 font-barlow text-lg font-semibold">
        <li>
          <a
            className="text-darkCyan transition-colors duration-300 ease-in-out hover:text-white"
            href="#"
          >
            About
          </a>
          ...
          <a href="#" className="group">
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="#2C7566"
                className="fill-darkCyan transition-colors duration-300 ease-in-out group-hover:fill-white"
              />
            </svg>
          </a>
        </li>
